    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 menu_button">
                <a href="/web/site">Ментальная Арифметика</a>
    ...
    echo Carousel::widget ( [
        'items' => [
            [
                ...
                'caption' => '<h2>ДОБРО ПОЖАЛОВАТЬ В МЕНТАЛЬНАЯ АРИФМЕТИКА</h2><p>ОБУЧЕНИЕ В НАШИХ ЦЕНТРАХ ВЕДЕТСЯ ПО СТАНДАРТАМ МЕЖДУНАРОДНОЙ 
...
ПРИ ПОМОЩИ АРИФМЕТИЧЕСКИХ ВЫЧИСЛЕНИЙ НА СЧЕТАХ (МЕНТАЛЬНАЯ АРИФМЕТИКА)</p><a href="#">ПОДРОБНЕЕ</a>',
                'options' => []
            ],
            [
                'content' => '<img src="/web/public/img/SliderBackground.jpg"/>',
            ...
            [
                'content' => '<img src="/web/public/img/SliderBackground.jpg"/>',
                'caption' => '<h2>ПАРТНЕРСТВО С "МЕНТАЛЬНАЯ АРИФМЕТИКА"</h2><p>МЫ ОТКРЫТЫ ДЛЯ ТЕХ, КТО ХОЧЕТ РАБОТАТЬ С НАМИ</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="quote"><b>Ментальная арифметика (Ментальная Арифметика) – это готовая оригинальная система развития интеллекта. Ментальная Арифметика формирует умственные и творческие способности вашего ребенка. Такие как:</b></p>
                ...
                <p>
                    Смекалка. Интуиция (6-е чувство). Нестандартные способы решения проблем. Творческие, познавательные и интеллектуальные способности. Что еще дает Ментальная Арифметика: Повышение успеваемости в школе. Уверенность и самостоятельность. Успешность!!!
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>2017. Ментальная арифметика Ментальная Арифметика | Курсы ментальной арифметики.</p>
