...
<?php $this->beginBody() ?>
    ...
    <script>
        ...
        function init() {
            ...
            var blue_bead = new createjs.Bitmap("<?=Url::to('@web/abac/assets/blue_bead.png')?>");
            var pink_bead = new createjs.Bitmap("<?=Url::to('@web/abac/assets/pink_bead.png')?>");
            ...
            function Circle(){
                ...
                for ( var i = 0; i < circleCount; i++){
                    wood[i] = [];
                    wood_line[i] = new createjs.Bitmap("<?=Url::to('@web/abac/assets/candy_cane.png')?>");
