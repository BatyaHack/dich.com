...
<?php $this->beginBody() ?>
    ...
    <img src="<?=Url::to('@web/space/assets/panel2.png')?>" hidden>
    <img src="<?=Url::to('@web/space/assets/button.png')?>" hidden>
    <img src="<?=Url::to('@web/space/assets/again.png')?>" hidden>
    <img src="<?=Url::to('@web/space/assets/quest2.png')?>" hidden>
    <img src="<?=Url::to('@web/space/assets/background2.jpg')?>" hidden>
...
<?php $this->endBody() ?>
    ...
    <script>
        function init() {
            ...
            var background = new createjs.Bitmap("<?=Url::to('@web/space/assets/background2.jpg')?>");
            var field = new createjs.Bitmap("<?=Url::to('@web/space/assets/panel2.png')?>");//Shape();
            var buttons = [], buttonTexts = [];
            var cn = cw; if (cw < ch) cn = ch;
            var textSize = cn / 48;
            var maxSteps = 0, steps = 1;
            var target_num = 0, level_num = 1, score_num = 0;
            var again_button = new createjs.Bitmap("<?=Url::to('@web/space/assets/again.png')?>")//Shape();
            ...
            var helpButton = new createjs.Bitmap("<?=Url::to('@web/space/assets/quest2.png')?>");
            var zone = new createjs.Shape();
            ...
            for (var i = 0; i < 3; i++) {
                buttons[i] = new createjs.Bitmap("<?=Url::to('@web/space/assets/button.png')?>");
                var zone = new createjs.Shape();
